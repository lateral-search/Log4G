package com.ls.mobile.geotool.graphic;
...
/**
 * Alternative implementation to plot graphics.
 *
 * @deprecated
 */
public class LSXYGraphicator  {
    ...
    public LSXYGraphicator(Activity act){
        mActivity = act;
    }

    public void init() {
         // :: R.id.graphBoard this is not going to work
        ImageView image = (ImageView) mActivity.findViewById(R.id.graphBoard);
